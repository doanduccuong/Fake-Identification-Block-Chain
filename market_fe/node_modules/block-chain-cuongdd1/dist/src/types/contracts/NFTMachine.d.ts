...
export declare namespace NFTMachine {
    type ProductStruct = {
        tokenId: BigNumberish;
        price: BigNumberish;
        uri: string;
    };
    type ProductStructOutput = [
        tokenId: bigint,
        price: bigint,
        uri: string
    ] & {
...
export interface NFTMachineInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "balanceOf" | "buyNFT" | "erc20Address" | "getAllNFT" | "getApproved" | "isApprovedForAll" | "mintNewNFT" | "name" | "owner" | "ownerOf" | "renounceOwnership" | "safeMint" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenIdToProduct" | "tokenURI" | "transferFrom" | "transferOwnership"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "mintNewNFT", values: [string, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "tokenIdToProduct", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "tokenIdToProduct", data: BytesLike): Result;
...
export interface NFTMachine extends BaseContract {
    connect(runner?: ContractRunner | null): NFTMachine;
    waitForDeployment(): Promise<this>;
    interface: NFTMachineInterface;
    ...
    buyNFT: TypedContractMethod<[_tokenId: BigNumberish], [void], "nonpayable">;
    erc20Address: TypedContractMethod<[], [string], "view">;
    getAllNFT: TypedContractMethod<[
    ], [
        NFTMachine.ProductStructOutput[]
    ], "view">;
    ...
    mintNewNFT: TypedContractMethod<[
        uri: string,
        price: BigNumberish
    ], [
        void
    ...
    tokenIdToProduct: TypedContractMethod<[
        arg0: BigNumberish
    ], [
        [
            bigint,
    ...
    getFunction(nameOrSignature: "buyNFT"): TypedContractMethod<[_tokenId: BigNumberish], [void], "nonpayable">;
    getFunction(nameOrSignature: "erc20Address"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "getAllNFT"): TypedContractMethod<[], [NFTMachine.ProductStructOutput[]], "view">;
    ...
    getFunction(nameOrSignature: "mintNewNFT"): TypedContractMethod<[
        uri: string,
        price: BigNumberish
    ], [
        void
    ...
    getFunction(nameOrSignature: "tokenIdToProduct"): TypedContractMethod<[
        arg0: BigNumberish
    ], [
        [
            bigint,
