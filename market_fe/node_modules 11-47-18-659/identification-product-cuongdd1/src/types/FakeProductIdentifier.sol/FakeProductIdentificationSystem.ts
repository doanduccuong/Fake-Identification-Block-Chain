...
export interface FakeProductIdentificationSystemInterface extends Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic: "ProductEvent" | "ProductVerified"
  ): EventFragment;
...
export namespace ProductEventEvent {
...
export interface FakeProductIdentificationSystem extends BaseContract {
  ...
  addProduct: TypedContractMethod<
    [_name: string, _productId: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  sellProduct: TypedContractMethod<
    [_productId: BigNumberish, _buyer: AddressLike, _price: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getEvent(
    ...
    ProductEventEvent.InputTuple,
    ProductEventEvent.OutputTuple,
    ProductEventEvent.OutputObject
  >;
  getEvent(
    key: "ProductVerified"
  ): TypedContractEvent<
  ...
  filters: {
    "ProductEvent(uint256,address,string,string,uint8)": TypedContractEvent<
      ProductEventEvent.InputTuple,
      ProductEventEvent.OutputTuple,
      ProductEventEvent.OutputObject
    >;
    ProductEvent: TypedContractEvent<
      ProductEventEvent.InputTuple,
      ProductEventEvent.OutputTuple,
      ProductEventEvent.OutputObject
    >;
